-- Otto Research Assistant - Simplified Schema (without vector extension)
-- Run this first if you get vector extension errors
...
CREATE TABLE user_content (
    ...
    -- Search and AI features (without vector for now)
